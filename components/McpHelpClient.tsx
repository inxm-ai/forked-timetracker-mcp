...
export default function McpHelpClient() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description: "Enter your TimeTracker MCP server URL and authentication details.",
    ...
    },
    {
      ...
      description: "Complete the OAuth authorization flow to connect your Claude client to your TimeTracker.",
      image: "/mcp-help/step5.png",
      icon: Key,
      details: "After clicking 'Connect', you'll be redirected to your TimeTracker for authentication. Sign in with your credentials."
    },
    {
      number: 6,
      ...
      <section className="container mx-auto px-6 py-12">
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Follow these step-by-step instructions to set up your TimeTracker MCP server with Claude. 
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-sm text-yellow-700 dark:text-yellow-300">
                              The URL shown in the image (<code className="bg-yellow-100 dark:bg-yellow-800 px-1 py-0.5 rounded text-xs">https://timetracker-mcp.lumile.com.ar/</code>) is just an example. 
                      ...
                      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mt-4">
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-sm text-blue-700 dark:text-blue-300">
                              After clicking &quot;Connect&quot;, Claude will redirect you to your TimeTracker deployment. 
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="space-y-2">
                            ...
                            <ul className="text-sm text-green-700 dark:text-green-300 space-y-1">
                              ...
                              <li>• <strong>Time Tracking:</strong> start/stop timers, add manual entries</li>
          ...
          <Card className="border-0 shadow-lg border-l-4 border-l-yellow-500">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                When connecting Claude to your TimeTracker MCP server, keep these security best practices in mind:
              </p>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mt-4">
                <p className="text-sm text-muted-foreground">
                  <strong>Note:</strong> This TimeTracker MCP server only accesses your time tracking data and 
