    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <span className="text-lg md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                <span className="sm:hidden">TimeTracker</span>
                <span className="hidden sm:inline">TimeTracker MCP</span>
              </span>
            </div>
            <div className="flex items-center gap-2 md:gap-3">
              {session ? (
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="text-center space-y-6 mb-16">
          <h2 className="text-3xl md:text-4xl font-bold">Why TimeTracker MCP?</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            TimeTracker MCP implements a <strong>conversational-first architecture</strong> that fundamentally reimagines software interaction patterns. Instead of adapting users to interface constraints, the system adapts to natural language expression.
          </p>
