...
export const metadata: Metadata = {
	title: "TimeTracker MCP",
	description: "Conversational, time-tracking project powered by the Model Context Protocol (MCP), made by Lumile Argentina S.A.",
};
								...
								<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
									...
									<div>
										...
										<ul className="space-y-2 text-sm">
											<li>
												<Link 
													href="https://github.com/lumile/timetracker-mcp" 
